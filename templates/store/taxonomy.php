<div class="wrap">
  ...
  <div class="tab-content">
      <div id="tab-1" class="tab-pane <?php echo !isset($_POST["edit_taxonomy"]) ? 'active' : '' ?>">
        ...
        echo '<table class="ds-table"><tr><th>ID</th><th>Singular Name</th><th class="text-center">Hierarchical</th><th class="text-center">Actions</th></tr>';
           ...
           settings_fields('dsports_plugin_tax_settings');
      ...
      <div id="tab-2" class="tab-pane <?php echo isset($_POST["edit_taxonomy"]) ? 'active' : '' ?>">
        ...
        <form method="post" action="options.php">
          <?php
              settings_fields('dsports_plugin_tax_settings');
              do_settings_sections('dsports_taxonomy');
              submit_button();
           ?>
        </form>
      </div>
