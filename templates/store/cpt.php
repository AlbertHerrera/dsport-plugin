<div class="wrap">
  ...
  <h1><strong>Dsports Plugin</strong> </h1>
  <hr>
  <?php settings_errors(); ?>
  ...
  <div class="tab-content">
      <div id="tab-1" class="tab-pane <?php echo !isset($_POST["edit_post"]) ? 'active' : '' ?>">
        ...
        $options = get_option( 'dsports_plugin_cpt') ?: array();
        echo '<table class="ds-table"><tr><th>ID</th><th>Singular Name</th><th>Plural Name</th><th class="text-center">Public</th><th class="text-center">Archive</th><th class="text-center">Actions</th></tr>';
          ...
          settings_fields('dsports_plugin_cpt_settings');
      ...
      <div id="tab-2" class="tab-pane <?php echo isset($_POST["edit_post"]) ? 'active' : '' ?>">
        ...
        <form method="post" action="options.php">
          <?php
              settings_fields('dsports_plugin_cpt_settings');
              do_settings_sections('dsports_cpt');
              submit_button();
           ?>
        </form>
      </div>
      <div id="tab-3" class="tab-pane">
        ...
        <?php	foreach ($options as $option) { ?>
          <h3> <?php echo $option['singular_name']; ?>
