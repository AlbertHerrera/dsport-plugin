...
*
*/
class ActivateTaxonomyManagerController extends BaseController{
public $settings;
...
public function setSubpages(){
  $this->subpages = array(
    array(
      ...
      'page_title' => 'Activate Taxonomy Manager',
      'menu_title' => 'Taxonomy Manager',
      'capability' => 'manage_options',
      'menu_slug' => 'Dsports_atm',
...
public function setSettings(){
  //store our settings
   $args = array(
           array(
             'option_group' => 'dsports_plugin_tax_settings',
             'option_name' => 'dsports_plugin_tax',
...
public function storeCustomTaxonomies()
{
  ...
  $options = get_option( 'dsports_plugin_tax') ?: array();
 //store
