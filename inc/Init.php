...
final class Init
{
	...
	public static function get_services()
	{
		return array(
			...
			Base\ActivateTaxonomyManagerController::class,
			Base\ActivateChatManagerController::class,
			Base\ActivateGalleryManagerController::class,
			Base\ActivateLoginManagerController::class,
